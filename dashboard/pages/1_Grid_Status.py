...
try:
    ...
    if df.empty:
        ...
        fig = px.line(net_load_data, x="time", y="value", 
    ...
    if 'unauthorized' in err_str:
        ...
        st.info("Please verify that `INFLUX_TOKEN`, `INFLUX_ORG`, and `INFLUX_BUCKET` are set correctly in your environment variables.", icon="🔐")
