...
st.info("The Financials dashboard is currently under development. Here we will track the Arbitrage Trader's charging and discharging revenues.")
...
fig = px.bar(df, x="Time", y="Revenue (USD)", color="Action",
             color_discrete_map={"Sell": "#00ffcc", "Buy": "#ff4b4b"},
             template="plotly_dark", title="Simulated Trading Hourly Revenue")
